...
export const NAVIGATION_ITEMS: NavigationItem[] = [
  ...
  { label: 'Rampa Kontrol', path: '/rampa-kontrol', icon: 'clipboard-check', roleKeys: ['control', 'admin', 'superadmin'] },
  { label: 'Vardiya Devir', path: '/vardiya-devir', icon: 'repeat', roleKeys: ['control', 'admin', 'superadmin'] },
  { label: 'Magaza Bilgileri', path: '/magaza-bilgileri', icon: 'store', roleKeys: ['control', 'admin', 'superadmin'] },
